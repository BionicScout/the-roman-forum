...
- **Normative Ethics:** Forms the major cohesive theoretical frameworks used to determine right and wrong actions:
	- *Virtue Ethics:* Emphasizes the development of moral character and systemic habits (e.g., Aristotelian ethics).
	- *Deontology:* Evaluates actions based on intrinsic duty, rules, and absolute maxims, completely independent of outcomes.
	- *Utilitarianism/Consequentialism:* Determines moral value purely by the net consequences and outcomes of an action.
